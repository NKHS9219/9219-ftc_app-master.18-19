...
@Autonomous(name ="Autonomous 9219 Depot")
public abstract class Autonomous9219Depot extends OpMode {
    ...
    public Mat process(Mat input) {
        ...
        if(choosenWhiteRect.get(0) != null && choosenWhiteRect.get(1) != null  && chosenYellowRect != null){
            ...
            if(leftCount == 0){
                currentOrder = Autonomous9219Depot.GoldLocation.LEFT;
            }

            if(leftCount == 1){
                currentOrder = Autonomous9219Depot.GoldLocation.CENTER;
            }

            if(leftCount >= 2){
                currentOrder = Autonomous9219Depot.GoldLocation.RIGHT;
            }
            isFound = true;
            lastOrder = currentOrder;

        }else{
            currentOrder = Autonomous9219Depot.GoldLocation.UNKNOWN;
